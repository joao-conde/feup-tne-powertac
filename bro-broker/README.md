...
The bro-broker package is a maven project, so it works to just do File->Import->Existing Maven Projects and select the bro-broker directory (the directory containing the pom.xml file). 
